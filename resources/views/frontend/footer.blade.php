<div class="bg-white pt-4 sm:pt-10 lg:pt-12 footer_div default-border">
    <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <div class="flex gap-4 footer_icon">
                ...
                <a href="https://github.com/humanizar-texto" target="_blank">
                    <svg width="64px" height="64px" viewBox="0 0 20 20" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#1d1e56">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
        ...
        <div class="py-8 text-center text-sm text-gray-400">© 2024 - Humanizar Texto</div>
    </footer>
</div>
...
<link
    ...
    rel="stylesheet">
<script src="{{ asset('asset_files/frontend/js/script.js?v1.4') }}"></script>
