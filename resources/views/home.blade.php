...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_files/frontend/css/style.css?v1.4') }}">
...
<body>
    <div class="container navigation px-10 bg-white mx-auto">
        <header class="flex items-center justify-between py-1" style="background-color: #fff !important">
            <!-- logo - start -->
    ...
    <section class="tool_wrapper mt-[20px]">
        <div class="tool">
        ...
        <div class="pt-10 flex gap-x-10">
            ...
            <div class="grid grid-cols-2 gap-5 mt-5">
                <div class="p-5 border-r border-b border-gray-300 rounded-lg bg-white">
                    <h3 class="text-[16px] mb-2 bg-[#be65a1] w-fit text-white rounded-[100px] px-5 py-1">Upload Files
                    </h3>
                ...
                <div class="p-5  border-l border-b border-gray-300 rounded-lg bg-white">
                    <h3 class="text-[16px] mb-2 bg-[#be65a1] w-fit text-white rounded-[100px] px-5 py-1">Click On
                        Convert</h3>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos nobis dolore, consequatur dolor
                        molestiae quis laudantium praesentium impedit veniam iusto?</p>
                </div>
                <div class="p-5 border-t border-r border-gray-300 rounded-lg bg-white">
                    <h3 class="text-[16px] mb-2 bg-[#be65a1] w-fit text-white rounded-[100px] px-5 py-1">Optical
                        Recognation Process</h3>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos nobis dolore, consequatur dolor
                        molestiae quis laudantium praesentium impedit veniam iusto?</p>
                </div>
                <div class="p-5 border-t border-l border-gray-300 rounded-lg bg-white">
                    <h3 class="text-[16px] mb-2 bg-[#be65a1] w-fit text-white rounded-[100px] px-5 py-1">Result With
                        Options</h3>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos nobis dolore, consequatur dolor
                        molestiae quis laudantium praesentium impedit veniam iusto?</p>
                </div>
    ...
    <section class="mt-20 max-w-[1280px] w-[80vw] m-auto pb-24">
        ...
        <div class="relative w-full sm:rounded-lg sm:px-10 ">
            <div class="mx-auto px-5">
                <div class="mx-auto mt-8 grid max-w-[900px] bg-white px-10 py-5 w-[90%] divide-y divide-neutral-200">
                    <div class="py-5">
                        <details class="group">
    ...
    <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="flex flex-col items-center justify-between gap-4 border-t border-b py-6 md:flex-row">
            ...
            <nav class="flex flex-wrap justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6">
                <a href="https://humanizar-texto.org/politica-de-privacidad" class="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">
                    Politica de Privacidad</a>
                <a href="https://humanizar-texto.org/terminos-y-condiciones" class="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">
            ...
            <div class="flex gap-4 footer_icon">
                <a href="https://www.facebook.com/humanizartexto1/" target="_blank" class="text-gray-400 transition duration-100">
                    <svg fill="#1d1e56" width="64px" height="64px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://x.com/humanizartexto" target="_blank" class="text-gray-400 transition duration-100">
                    <svg fill="#1d1e56" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512" xml:space="preserve">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <a href="https://www.linkedin.com/company/humanizar-texto" target="_blank" class="text-gray-400 transition duration-100">
                    <svg fill="#1d1e56" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512" xml:space="preserve">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <a href="https://www.reddit.com/user/humanizartexto/" target="_blank" class="text-gray-400 transition duration-100">
                    <svg fill="#1d1e56" width="64px" height="64px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <a href="https://www.pinterest.com/humanizartexto/" target="_blank" class="text-gray-400 transition duration-100">
                    <svg fill="#1d1e56" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512" xml:space="preserve">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <a href="https://www.youtube.com/@HumanizarTexto" target="_blank" class="text-gray-400 transition duration-100">
                    <svg fill="#1d1e56" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512" xml:space="preserve">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <a href="https://github.com/humanizar-texto" target="_blank">
                    <svg width="64px" height="64px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#1d1e56">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -7559.000000)" fill="#1d1e56">
